              ...
              <div className="bg-white rounded-[2rem] p-5 shadow-sm border border-slate-100 h-full flex flex-col">
                ...
                {dutyData.dayAssignments.length === 0 ? (
                  <div className="text-center text-slate-400 py-8 flex-1 flex flex-col items-center justify-center">
                    <Shield size={32} className="mb-2 opacity-50 text-[#8779fb]" />
                  ...
                  <div className="space-y-4 flex-1">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full border border-slate-200 rounded-xl px-4 py-2 text-sm focus:outline-none focus:border-[#8779fb] focus:ring-1 focus:ring-[#8779fb]"
                      />
                    </div>
                  </div>
                )}
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-[#8779fb] hover:bg-[#655ac1] text-white py-3 rounded-xl text-sm font-bold shadow-md shadow-[#8779fb]/20 transition-all active:scale-95 mt-4 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <Plus size={18} />
              ...
              <div className="bg-white rounded-[2rem] p-5 shadow-sm border border-slate-100 min-h-[400px]">
                ...
                {savedSchedules.length === 0 ? (
                  <div className="text-center text-slate-400 py-16">
                    <Settings size={48} className="mx-auto mb-4 opacity-20 text-[#8779fb]" />
                  ...
                  <div className="space-y-3 max-h-[450px] overflow-y-auto pr-2 custom-scrollbar">
                    {savedSchedules.map(schedule => (
                      <div key={schedule.id} className={`p-4 rounded-xl border-2 transition-all ${dutyData.activeScheduleId === schedule.id ? 'border-[#8779fb] bg-violet-50/50/50 shadow-sm' : 'border-slate-100 bg-white hover:border-[#8779fb]/40'}`}>
                               ...
                               {editingId === schedule.id ? (
                                 <div className="flex items-center gap-2">
                                   <input
                                      ...
                                      className="border border-[#8779fb] rounded-lg px-2 py-1 text-sm font-bold text-slate-800 outline-none"
                                   />
