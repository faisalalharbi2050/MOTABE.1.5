...
const STEPS = [
  { id: 1, title: 'الإعدادات الأساسية', icon: Shield },
  { id: 2, title: 'إعدادات المشرفين', icon: Users },
  { id: 3, title: 'مواقع الإشراف', icon: MapPin },
  { id: 4, title: 'فترات الإشراف', icon: Clock },
];
