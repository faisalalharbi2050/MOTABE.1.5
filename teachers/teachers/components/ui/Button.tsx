...
export function Button({ 
  ...
  const variants = {
    primary: "bg-primary text-white shadow-lg shadow-primary/20 hover:bg-[#564ba3] hover:shadow-primary/30",
    secondary: "bg-white text-primary border border-primary/20 hover:bg-primary/5",
    outline: "bg-transparent border border-gray-200 text-gray-600 hover:bg-gray-50 hover:text-gray-900",
